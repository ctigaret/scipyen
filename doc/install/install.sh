...
function dopyqt5 ()
{
    ...
    sip-build --qmake="$qmake_binary" --confirm-license --build-dir ../PyQt5-build --qt-shared --disable QtQuick3D --disable QtRemoteObjects --no-dbus-python --pep484-pyi --no-make --verbose --target-dir $VIRTUAL_ENV
