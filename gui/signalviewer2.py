...
class SignalViewer2(ScipyenFrameViewer, Ui_SignalViewerWindow):
    """ A plotter for multi-sweep signals ("frames" or "segments"), with cursors.
        ...
        Python data types handled by SignalViewer2 as of 2019-11-23 11:30:23:
        --------------------------------------------------------------------
    ...
    def __init__(self, x: (neo.core.baseneo.BaseNeo, DataSignal, IrregularlySampledDataSignal, TriggerEvent, TriggerProtocol, vigra.filters.Kernel1D, np.ndarray, tuple, list, type(None)) = None, y: (neo.core.baseneo.BaseNeo, DataSignal, IrregularlySampledDataSignal, TriggerEvent, TriggerProtocol, vigra.filters.Kernel1D, np.ndarray, tuple, list, type(None)) = None, parent: (QtWidgets.QMainWindow, type(None)) = None, ID:(int, type(None)) = None, win_title: (str, type(None)) = None, doc_title: (str, type(None)) = None, frameIndex:(int, tuple, list, range, slice, type(None)) = None, frameAxis:(int, type(None)) = None, signalIndex:(str, int, tuple, list, range, slice, type(None)) = None, signalChannelAxis:(int, type(None)) = None, signalChannelIndex:(int, tuple, list, range, slice, type(None)) = None, irregularSignalIndex:(str, int, tuple, list, range, slice, type(None)) = None, irregularSignalChannelAxis:(int, type(None)) = None, irregularSignalChannelIndex:(int, tuple, list, range, slice, type(None)) = None, separateSignalChannels:bool = False, singleFrame:bool=False, interval:(tuple, list) = None, channelIndex:object = None, currentFrame:(int, type(None)) = None, plotStyle: str = "plot", nAxes:typing.Optional[int] = None,*args, **kwargs):
        ...
        # We then call self.setData(...) below, tailored for SignalViewer2.
    ...
    def _(self, x:neo.core.dataobject.DataObject, **kwargs):
        ...
        # print("SignalViewer2._interpret_signal", type(x))
    ...
    def _plot_discrete_entities_(self, /, entities:typing.Union[dict, list, neo.core.spiketrainlist.SpikeTrainList], axis:pg.PlotItem, clear:bool=True, adapt_X_range:bool=True, minX:typing.Optional[float]=None, maxX:typing.Optional[float]=None, **kwargs):
        ...
        try:
            ...
            if all(isinstance(v, neo.Event) for v in entities_list):
                ...
                # if adapt_X_range:
                #     self._adapt_X_range_(entities_axis)
    ...
    def _gen_signal_ndx_name_map_(self, signals:typing.Union[tuple, list]):
        ...
        """
        sig_ndx_names = list(map(lambda x: (x[0],x[1]) if isinstance(x[1], str) and len(x[1].strip()) else (x[0],f"Analog signal {x[0]}") , ((k,getattr(s, "name", "Analog signal {k}")) for k,s in enumerate(signals))))
    ...
    def _setup_signal_choosers_(self, analog:typing.Optional[list] = None, irregular:typing.Optional[list] = None):
        """ Populated signal choosers based on the analog and irregular signals
        """
        ...
        if irregular is None or (isinstance(irregular, (tuple, list)) and len(irregular) == 0):
            ...
            self._frame_irregs_map_ = self._gen_signal_ndx_name_map_(irregs)
    ...
    def addCursor(self, cursorType: typing.Union[str, SignalCursorTypes] = "c", x: typing.Optional[numbers.Number] = None, y: typing.Optional[numbers.Number] = None, xwindow: typing.Optional[numbers.Number] = None, ywindow: typing.Optional[numbers.Number] = None, xBounds: typing.Optional[numbers.Number] = None, yBounds: typing.Optional[numbers.Number] = None, label: typing.Optional[typing.Union[int, str, pg.PlotItem]] = None, follows_mouse: bool = False, axis: typing.Optional[int] = None, **kwargs):
        ...
        axis: None (default), int, the str "all" or "a" (case-insensitive), or
            ...
            that belong to this instance of SignalViewer2.
    ...
    def slot_selectCursor(self, crsID=None):
        #print("SignalViewer2.slot_selectCursor", crsID)
        if len(self._data_cursors_) == 0:
            return
...
#             
        ...
        *cursors: a sequence of vertical or crosshair cursors; possibly empty
        ...
        if all_segments and relative_to_segment_start:
            ...
            if not all(ss == seg_starts[0] for ss in seg_starts):
                ...
                # print(f"SignalViewer2.cursorsToEpoch: rel_starts: {rel_starts}")
    ...
    @safeWrapper
    def _parse_data_(self, x, y, frameIndex, frameAxis, signalChannelAxis, signalIndex, signalChannelIndex, irregularSignalIndex, irregularSignalChannelAxis, irregularSignalChannelIndex, separateSignalChannels, singleFrame):
        ...
        if isinstance(y, neo.core.Block):
            ...
            if np.all([isinstance(i, vigra.filters.Kernel1D) for i in y]):
                ...
                # CAUTION: the risk is of too many signals (and PlotItems)
                if isinstance(frameAxis, int):
                    if frameAxis != 1:
                        raise ValueError(f"invalid frameAxis {frameAxis}")
                    self.frameAxis = frameAxis
                elif frameAxis is None:
                    self.frameAxis = None
    ...
    def setData(self, x:(neo.core.baseneo.BaseNeo, DataSignal, IrregularlySampledDataSignal, TriggerEvent, TriggerProtocol, vigra.filters.Kernel1D, np.ndarray, tuple, list, type(None)), /, y:(neo.core.baseneo.BaseNeo, DataSignal, IrregularlySampledDataSignal, TriggerEvent, TriggerProtocol, vigra.filters.Kernel1D, np.ndarray, tuple, list, type(None)) = None,doc_title:(str, type(None)) = None, frameAxis:(int, str, vigra.AxisInfo, type(None)) = None, signalChannelAxis:(int, str, vigra.AxisInfo, type(None)) = None, frameIndex:(int, tuple, list, range, slice, type(None)) = None, signalIndex:(str, int, tuple, list, range, slice, type(None)) = None, signalChannelIndex:(int, tuple, list, range, slice, type(None)) = None, irregularSignalIndex:(str, int, tuple, list, range, slice, type(None)) = None, irregularSignalChannelAxis:(int, type(None)) = None, irregularSignalChannelIndex:(int, tuple, list, range, slice, type(None)) = None, separateSignalChannels:bool = False, singleFrame:bool=False, interval:(tuple, list, neo.Epoch, type(None)) = None, plotStyle:str = "plot", get_focus:bool = False, showFrame = None, *args, **kwargs):
        ...
        x: data to plot.
            ...
            sigview = SignalViewer2() # create a SignalViewer2 object
...
#         self.framesQSlider.setValue(self._current_frame_index_)
    ...
    def displayFrame(self):
        ...
        datatypes.DataSignal            ↦ _plot_signal_
    ...
    def _align_X_range(self, padding:typing.Optional[float] = None):
        ...
        for k, ax in enumerate(self.axes):
            if ax.isVisible():
                ...
                if k == 0 or any(v is None for v in (minX, maxX)):
                    ...
                    # also set range and display x label just in case
                    # ax.setXRange(minX, maxX, padding=padding)
                    # ax.getAxis("bottom").showLabel(True)
                    # ax.getAxis("bottom").setStyle(showValues=True)
        ...
        # hide X axis values for axes with same X boundaries ONLY if their X dmain have same units (as described in the label)
        for kax, ax in enumerate(self.axes):
            if ax.isVisible():
                ...
                if kax > 0:
                    ...
                    # print(f"kax {kax} sameLabel {sameLabel}: ax {kax-1} {prev_ax.getAxis('bottom').labelText} ; ax {kax} {ax.getAxis('bottom').labelText} ")
...
#     def _adapt_X_range_(self, plotItem):
#         axes = list(ax for ax in self.signalAxes if ax.isVisible())
#         if plotItem in axes:
#             return
#         
#         if len(axes):
...
#                     continue
#                 items_min_x, items_max_x = zip(*list((float(np.nanmin(i.xData)), float(np.nanmax(i.xData))) for i in pdis))
#                 min_x.append(np.nanmin(items_min_x))
#                 max_x.append(np.nanmax(items_max_x))
#                         
#             minX = min(min_x) if len(min_x) else None
#             maxX = max(max_x) if len(max_x) else None
#                   
#             if all(isinstance(v, float) for v in (minX, maxX)):
#                 plotItem.setXRange(minX, maxX)
#         
...
#             
    ...
    def _(self, obj, *args, **kwargs):
        ...
        if all([isinstance(y_, (DataSignal, 
            ...
            # FIXME
            self._setup_signal_choosers_(obj)
...
#         maxX = max(max_x)
    ...
    def _plot_signal_(self, signal, *args, **kwargs):
        ...
        if not isinstance(signal, neo.core.baseneo.BaseNeo):
            raise TypeError("_plot_signal_ expects an object from neo framework, or a datatypes.DataSignal or datatypes.IrregularlySampledDataSignal; got %s instead" % (type(signal).__name__))
        ...
        if self.separateSignalChannels:
            ...
            for (k, channel) in enumerate(chNdx):
                ...
                if plot_name != self.axis(k).vb.name:
                    # if plot_name not in self._frame_analog_map_.keys():
                    #     sig_tuple = (k, sig.name)
                    #     original = 
                    #     self._frame_analog_map_[plot_name] = sig_tuple
                    self._register_plot_item_name_(self.axis(k), plot_name)
            ...
            if sig.name != self.axis(0).vb.name:
                self._register_plot_item_name_(self.axis(0), sig.name)
            self.axis(0).register(sig.name)
            self.axis(0).setVisible(True)
    ...
    def _setup_axes_(self):
        ...
        if len(self.signalAxes) < self._n_signal_axes_:
            # there exist fewer signal axes than needed - create here as necessary
    ...
    def setTitlePrefix(self, value):
        ...
        if isinstance(value, str) and len(value.strip()) > 0:
            ...
            self._winTitle_ = "SignalViewer2%d" % self._ID_
