...
#class FlexiConsole(RichJupyterWidget):
...
##        super(RichIPythonWidget, self).__init__()
        ...
        #if not isinstance(kernel_manager, jupyter_client.KernelManager):
...
class ScipyenWindow(WindowManager, __UI_MainWindow__):
    ...
    @pyqtSlot(object)
    @safeWrapper
    def _slot_extkrn_shell_msg_exe_rep_ctnt_received(self, msg):
        pass
