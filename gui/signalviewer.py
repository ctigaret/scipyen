...
class SignalCursor(QtCore.QObject):
    ...
    def _setup_(self, host, cursor_type="crosshair", x=None, y=None, 
        ...
        if isinstance(cursor_type, (tuple, list)) and len(cursor_type) == 2 and all([isinstance(c, bool) for c in cursor_type]):
            ...
            show_lines = SignalCursor._cursorTypes_[cursor_type]
...
class SignalViewer(ScipyenFrameViewer, Ui_SignalViewerWindow):
    ...
    def _configureGUI_ (self):
        ...
        self.addVerticalCursorAction = self.addCursorsMenu.addAction("Vertical SignalCursor")
        self.addVerticalCursorAction.triggered.connect(self.slot_addVerticalCursor)
        
        self.addHorizontalCursorAction = self.addCursorsMenu.addAction("Horizontal SignalCursor")
        self.addHorizontalCursorAction.triggered.connect(self.slot_addHorizontalCursor)
        
        self.addCrosshairCursorAction = self.addCursorsMenu.addAction("Crosshair SignalCursor")
