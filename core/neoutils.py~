...
def neo_copy(src: typing.Union[neo.Block, neo.Segment, neo.ChannelIndex, neo.Unit]) -> typing.Union[neo.Block, neo.Segment, neo.ChannelIndex, neo.Unit]:
    ...
    elif isinstance(src, neo.Epoch) or type(src).__name__ == "Epoch":
    ...
    elif isinstance(src, neo.Event) or type(src).__name__ == "Event":
    ...
    if isinstance(x, neo.Segment):
        ...
        if len(x.events):
            if not all([isinstance(e, neo.Event) for e in x.events]):
                ee = list()
                for e in x.events:
                    if type(e).__name__ == "TriggerEvent" or isinstance(e, neo.Event):
                        ee.append(e)
                        
                    elif type(e).__name__ == "Event": # neoevent.Event
                        ee.append(neo_copy(e))
                    else:
