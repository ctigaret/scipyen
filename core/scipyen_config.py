...
class ScipyenConfigurable(object):
    ...
    def __init__(self, configTag:typing.Optional[str]=None):
        ...
        print(f"ScipyenConfigurable.__init__ _scipyen_settings_ {scipyen_config}, _user_settings_src_ {scipyen_user_config_source}, _user_settings_file_ {_user_settings_src_.filename}")
