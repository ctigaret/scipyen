...
class NeoPatchCtx(ContextDecorator):
    ...
    #def _load_neo_patch_(self, *mnames):
        #for mname in mnames:
                ...
                #self.neo_patches.add(mname)
        
        
    
    def __enter__(self):
        #self._load_neo_patch_("neoevent", "neoepch", "patchneo")
        ...
        #print ("NeoPatchCtx.__enter__: patchneo in sys.modules =", "patchneo" in sys.modules)
        
        #neo.core.dataobject._normalize_array_annotations = patchneo._normalize_array_annotations
        #neo.core.dataobject._normalize_array_annotations = sys.modules["patchneo"]._normalize_array_annotations
        #neo.core.analogsignal._new_AnalogSignalArray = sys.modules["patchneo"]._new_AnalogSignalArray_v1
        #neo.core.spiketrain._new_spiketrain = sys.modules["patchneo"]._new_spiketrain_v1
        #neo.core.irregularlysampledsignal._new_IrregularlySampledSignal = sys.modules["patchneo"]._new_IrregularlySampledSignal_v1
        
        #neo.core.event._new_event = sys.modules["neoevent"]._new_event
        #neo.core.event.Event = sys.modules["neoevent"].Event
        #neo.core.Event = sys.modules["neoevent"].Event
        #neo.io.axonio.Event = sys.modules["neoevent"].Event
        #neo.Event = sys.modules["neoevent"].Event
        
        #neo.core.epoch.Epoch = sys.modules["neoepoch"].Epoch
        #neo.core.Epoch = sys.modules["neoepoch"].Epoch
        #neo.Epoch = sys.modules["neoepoch"].Epoch
