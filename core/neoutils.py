...
def __container_lookup__(container, contained_type, index_obj) -> dict:
    ...
    if isinstance(container, neo.container.Container):
        ...
        ret = dict((cname, normalized_index(getattr(container, cname), index_obj)) for cname in member_collection_names if hasattr(container, cname))
        ...
        return dict((cname, pfun(getattr(container, cname))) for cname in child_container_names if hasattr(container, cname))
        
    return dict()

def __collection_lookup__(seq, contained_type, index_obj) -> dict:
    """ Case 3
    """
...
def neo_lookup(src: typing.Union[neo.core.container.Container, typing.Sequence[neo.core.container.Container]],
    ...
    if isinstance(src, (tuple, list)):
        ...
        return __container_lookup__(src, ctype, index)
