...
Author:
Miguel Turner
https://gist.github.com/dhagrow/d3414e3c6ae25dfa606238355aea2ca5#gistcomment-2381269
...
def create_function2(name, signature, callback):
    """Dynamically creates a function that wraps a call to *callback*, based
    on the provided *signature*.
    """
    # utils to set default values when creating a ast objects
...
def functionFactory(name, signature, callback):
    """Dynamically creates a function that wraps a call to *callback*, based
    on the provided *signature*.
    """
