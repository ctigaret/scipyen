...
@safewrapper
def detect_trigger_events(x: neo.AnalogSignal,
                          event_type: typing.Union[TriggerEventType, str],
                          use_lo_hi=True,
                          label=None,
    ...
    event_type: a triggerevent.TriggerEventType enum value or triggerevent.TriggerEventType name (str)
...
def remove_trigger_protocol(protocol: TriggerProtocol, block: neo.Block):
...
def modify_trigger_protocol(protocol: TriggerProtocol, block: neo.Block):
    r"""
...
def embed_trigger_event(event: TriggerEvent, segment: neo.Segment,
                        clea: bool = False):
    r"""
...
def embed_trigger_protocol(protocol: TriggerProtocol,
                           target: typing.Union[
                               neo.Block, neo.Segment,
                               typing.Sequence[neo.Segment]
                               ],
...
@safewrapper
def parse_trigger_protocols(
    src: typing.Union[neo.Segment, neo.Block,
                    typing.Sequence[neo.Segment],
                    typing.Sequence[neo.Block]
                    ],
    return_source:typing.Optional[bool]=False):
