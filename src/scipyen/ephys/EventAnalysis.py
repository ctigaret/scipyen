...
class EventAnalysis(ScipyenFrameViewer, __Ui_EventDetectWindow__):
    sig_AbortDetection = Signal(name="sig_AbortDetection")
...
#### BEGIN _configureUI_
    def _configureUI_(self):
        ...
        #       generated by loadUiType function in PyQt. The custom class MUST
        #       inherit from the Python class generated automatically by 
        #       loadUiType - see PyQt documentation for details.
        #   
        # Disadvantages:
...
#### END _configureUI_        
    ...
    def alignWaves(self, detectionChannel:typing.Optional[int]=None, on_rising:typing.Optional[bool]=None, **kwargs):
        ...
        for k,train in enumerate(trains):
            ...
            if isinstance(progressSignal, QtCore.SignalInstance):
