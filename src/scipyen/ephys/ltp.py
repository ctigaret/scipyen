...
class LTPOnlineNew(QtCore.QObject):
...
# 
       ...
       # TODO: 2023-09-29 13:57:13
        ...
        self._abfProducerThread_ = _LTPOnlineProducer_(self, self._abfRunBuffer_,
                                    self._mutex_, self._abfRunBufferEmptyCondition_,
