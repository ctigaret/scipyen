...
class LTPOnline(QtCore.QObject):
    ...
    def __init__(self, *args,
        ...
        if self._doSimulation_:
            ...
            if not autoStart:
                print(f"\nCall start() method of this LTPOnline instance to simulate a Clampex experiment usin ABF fils in {directory}.\n", file = sys.stdout)
            ...
            self._abfSupplierThread_ = _LTPOnlineSupplier_(self, self._abfTrialBuffer_,
                                        ...
                                        out = self._stdout_)
            if not autoStart:
                print(f"\nCall start() method of this LTPOnline instance to listen to ABF files generated by Clampex in {directory}.\n", file = sys.stdout)
