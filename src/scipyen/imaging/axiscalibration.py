...
class AxisCalibrationData(CalibrationData):
    r"""Calibration data for an array axis.
        ...
        • Fields specific for a NonChannel axis (see vigra.AxisType for details):
            ...
            'resolution': float or complex — the sampling resolution along the
    ...
    For a Channels axis, this is the number of channels.

    .. note::
        For a virtual Channels axis, size is 0 but there should be at lest one
