...
class SynapticPathwayWidget(Ui_SynapticPathwayWidget, QWidget):
    ...
    def __init__(self, parent: typing.Optional[QtWidgets.QWidget] = None,
        ...
        self._pathwayTypeNames_ = list(ephys.SynapticPathwayType.names())
    ...
    def _slot_pathwayTypeChanged(self, val: int | str):
        ...
        if isinstance(val, str):
            if val in self._pathwayTypeNames_:
                self._pathType_ = ephys.SynapticPathwayType[val]
            else:
                return
        else:
            return
    ...
    def _make_value_(self):
        self._data_ = ephys.SynapticPathway(self._name_, self._adc_, self._dac_,
    ...
    def value(self) -> ephys.SynapticPathway:
        return self._data_
