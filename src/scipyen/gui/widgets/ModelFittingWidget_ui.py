...
class Ui_ModelFittingWidget(object):
    def setupUi(self, ModelFittingWidget):
        ...
        ModelFittingWidget.resize(581, 651)
        ...
        sizePolicy1.setHeightForWidth(self.svgWidget.sizePolicy().hasHeightForWidth())
        self.svgWidget.setSizePolicy(sizePolicy1)
        ...
        self.layoutWidget = QWidget(self.labelsSplitter)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.verticalLayout = QVBoxLayout(self.layoutWidget)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.controlsSplitter = QSplitter(self.layoutWidget)
        ...
        self.controlsVerticalLayout = QVBoxLayout(self.layoutWidget1)
        self.controlsVerticalLayout.setObjectName(u"controlsVerticalLayout")
        self.controlsVerticalLayout.setContentsMargins(0, 0, 0, 0)
        self.waveParamsLayout = QVBoxLayout()
        self.waveParamsLayout.setObjectName(u"waveParamsLayout")
        self.domainStartLabel = QLabel(self.layoutWidget1)
        self.domainStartLabel.setObjectName(u"domainStartLabel")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.domainStartLabel.sizePolicy().hasHeightForWidth())
        self.domainStartLabel.setSizePolicy(sizePolicy2)

        self.waveParamsLayout.addWidget(self.domainStartLabel)

        self.horizontalLayout = QHBoxLayout()
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.startSpinBox = QuantitySpinBox(self.layoutWidget1)
        self.startSpinBox.setObjectName(u"startSpinBox")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Fixed)
        sizePolicy3.setHorizontalStretch(1)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.startSpinBox.sizePolicy().hasHeightForWidth())
        self.startSpinBox.setSizePolicy(sizePolicy3)

        self.horizontalLayout.addWidget(self.startSpinBox)

        self.setAsX0ToolButton = QToolButton(self.layoutWidget1)
        self.setAsX0ToolButton.setObjectName(u"setAsX0ToolButton")
        icon1 = QIcon(QIcon.fromTheme(u"arrow-right"))
        self.setAsX0ToolButton.setIcon(icon1)
        self.setAsX0ToolButton.setAutoRaise(True)

        self.horizontalLayout.addWidget(self.setAsX0ToolButton)


        self.waveParamsLayout.addLayout(self.horizontalLayout)

        self.label_Duration = QLabel(self.layoutWidget1)
        ...
        sizePolicy4.setHeightForWidth(self.label_Duration.sizePolicy().hasHeightForWidth())
        self.label_Duration.setSizePolicy(sizePolicy4)

        self.waveParamsLayout.addWidget(self.label_Duration)

        self.durationSpinBox = QuantitySpinBox(self.layoutWidget1)
        self.durationSpinBox.setObjectName(u"durationSpinBox")
        sizePolicy3.setHeightForWidth(self.durationSpinBox.sizePolicy().hasHeightForWidth())
        self.durationSpinBox.setSizePolicy(sizePolicy3)

        self.waveParamsLayout.addWidget(self.durationSpinBox)

        self.samplingRateLabel = QLabel(self.layoutWidget1)
        self.samplingRateLabel.setObjectName(u"samplingRateLabel")
        sizePolicy4.setHeightForWidth(self.samplingRateLabel.sizePolicy().hasHeightForWidth())
        self.samplingRateLabel.setSizePolicy(sizePolicy4)
        self.samplingRateLabel.setTextFormat(Qt.TextFormat.AutoText)
        self.samplingRateLabel.setWordWrap(False)

        self.waveParamsLayout.addWidget(self.samplingRateLabel)

        self.samplingRateSpinBox = QuantitySpinBox(self.layoutWidget1)
        self.samplingRateSpinBox.setObjectName(u"samplingRateSpinBox")
        sizePolicy3.setHeightForWidth(self.samplingRateSpinBox.sizePolicy().hasHeightForWidth())
        self.samplingRateSpinBox.setSizePolicy(sizePolicy3)

        self.waveParamsLayout.addWidget(self.samplingRateSpinBox)

        self.waveUnitsHorizontalLayout = QHBoxLayout()
        self.waveUnitsHorizontalLayout.setObjectName(u"waveUnitsHorizontalLayout")
        self.waveformUnitsLabel = QLabel(self.layoutWidget1)
        self.waveformUnitsLabel.setObjectName(u"waveformUnitsLabel")
        sizePolicy4.setHeightForWidth(self.waveformUnitsLabel.sizePolicy().hasHeightForWidth())
        self.waveformUnitsLabel.setSizePolicy(sizePolicy4)

        self.waveUnitsHorizontalLayout.addWidget(self.waveformUnitsLabel)

        self.unitsLabel = QLabel(self.layoutWidget1)
        self.unitsLabel.setObjectName(u"unitsLabel")
        sizePolicy4.setHeightForWidth(self.unitsLabel.sizePolicy().hasHeightForWidth())
        self.unitsLabel.setSizePolicy(sizePolicy4)

        self.waveUnitsHorizontalLayout.addWidget(self.unitsLabel)

        self.waveformUnitsPushButton = QPushButton(self.layoutWidget1)
        self.waveformUnitsPushButton.setObjectName(u"waveformUnitsPushButton")
        sizePolicy4.setHeightForWidth(self.waveformUnitsPushButton.sizePolicy().hasHeightForWidth())
        self.waveformUnitsPushButton.setSizePolicy(sizePolicy4)

        self.waveUnitsHorizontalLayout.addWidget(self.waveformUnitsPushButton)


        self.waveParamsLayout.addLayout(self.waveUnitsHorizontalLayout)


        self.controlsVerticalLayout.addLayout(self.waveParamsLayout)

        self.scrollArea = QScrollArea(self.layoutWidget1)
        ...
        sizePolicy5.setHeightForWidth(self.fitResultsTextEdit.sizePolicy().hasHeightForWidth())
        self.fitResultsTextEdit.setSizePolicy(sizePolicy5)
        self.fitResultsTextEdit.setReadOnly(True)

        self.gridLayout_2.addWidget(self.fitResultsTextEdit, 1, 0, 1, 1)
        ...
        self.layoutWidget11 = QWidget(self.controlsSplitter)
        self.layoutWidget11.setObjectName(u"layoutWidget11")
        self.coefficientsTableVerticalLayout = QVBoxLayout(self.layoutWidget11)
        ...
        self.modelCoefficientsTable = TableEditorWidget(self.layoutWidget11)
        self.modelCoefficientsTable.setObjectName(u"modelCoefficientsTable")
        sizePolicy1.setHeightForWidth(self.modelCoefficientsTable.sizePolicy().hasHeightForWidth())
        self.modelCoefficientsTable.setSizePolicy(sizePolicy1)
        ...
        self.removeStarredRowsPushButton = QPushButton(self.layoutWidget11)
        ...
        self.controlsSplitter.addWidget(self.layoutWidget11)

        self.verticalLayout.addWidget(self.controlsSplitter)

        self.waveControlAndDisplayHLayout = QHBoxLayout()
        self.waveControlAndDisplayHLayout.setSpacing(0)
        self.waveControlAndDisplayHLayout.setObjectName(u"waveControlAndDisplayHLayout")
        self.makeUnitAmplitudePushButton = QPushButton(self.layoutWidget)
        self.makeUnitAmplitudePushButton.setObjectName(u"makeUnitAmplitudePushButton")
        sizePolicy2.setHeightForWidth(self.makeUnitAmplitudePushButton.sizePolicy().hasHeightForWidth())
        self.makeUnitAmplitudePushButton.setSizePolicy(sizePolicy2)
        ...
        self.generateWaveformPushButton = QPushButton(self.layoutWidget)
        ...
        self.overlayDataCheckbox = QCheckBox(self.layoutWidget)
        self.overlayDataCheckbox.setObjectName(u"overlayDataCheckbox")
        sizePolicy2.setHeightForWidth(self.overlayDataCheckbox.sizePolicy().hasHeightForWidth())
        self.overlayDataCheckbox.setSizePolicy(sizePolicy2)
        icon6 = QIcon(QIcon.fromTheme(u"layer-visible-on"))
        self.overlayDataCheckbox.setIcon(icon6)

        self.waveControlAndDisplayHLayout.addWidget(self.overlayDataCheckbox)

        self.fitDataPushButton = QPushButton(self.layoutWidget)
        self.fitDataPushButton.setObjectName(u"fitDataPushButton")
        sizePolicy2.setHeightForWidth(self.fitDataPushButton.sizePolicy().hasHeightForWidth())
        self.fitDataPushButton.setSizePolicy(sizePolicy2)
        icon7 = QIcon(QIcon.fromTheme(u"labplot-xy-fit-curve"))
        self.fitDataPushButton.setIcon(icon7)
        ...
        self.channelSpinBox = QSpinBox(self.layoutWidget)
        self.channelSpinBox.setObjectName(u"channelSpinBox")
        sizePolicy2.setHeightForWidth(self.channelSpinBox.sizePolicy().hasHeightForWidth())
        self.channelSpinBox.setSizePolicy(sizePolicy2)
        self.channelSpinBox.setMaximum(9999)

        self.waveControlAndDisplayHLayout.addWidget(self.channelSpinBox)

        self.pythonHelpPushButton = QPushButton(self.layoutWidget)
        self.pythonHelpPushButton.setObjectName(u"pythonHelpPushButton")
        sizePolicy2.setHeightForWidth(self.pythonHelpPushButton.sizePolicy().hasHeightForWidth())
        self.pythonHelpPushButton.setSizePolicy(sizePolicy2)
        icon8 = QIcon(QIcon.fromTheme(u"info"))
        self.pythonHelpPushButton.setIcon(icon8)
        ...
        self.verticalLayout.addLayout(self.waveControlAndDisplayHLayout)

        self.labelsSplitter.addWidget(self.layoutWidget)
    ...
    def retranslateUi(self, ModelFittingWidget):
...
#if QT_CONFIG(tooltip)
        self.setAsX0ToolButton.setToolTip(QCoreApplication.translate("ModelFittingWidget", u"Set as x0 coefficient", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.setAsX0ToolButton.setStatusTip(QCoreApplication.translate("ModelFittingWidget", u"Set as x0 coefficient", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.setAsX0ToolButton.setWhatsThis(QCoreApplication.translate("ModelFittingWidget", u"<html><head/><body><p>Assin this value to x0 coefficient (as a float)</p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.setAsX0ToolButton.setText(QCoreApplication.translate("ModelFittingWidget", u"X\u2080", None))
#if QT_CONFIG(tooltip)
        ...
        self.exportModelWaveformToolButton.setText(QCoreApplication.translate("ModelFittingWidget", u"Export Model Waveform", None))
#if QT_CONFIG(tooltip)
        ...
        self.exportFitCurveToolButton.setText(QCoreApplication.translate("ModelFittingWidget", u"Export fitted curve", None))
