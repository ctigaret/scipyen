...
class Ui_ModelFittingWidget(object):
    def setupUi(self, ModelFittingWidget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 262, 192))
...
#if QT_CONFIG(tooltip)
        self.makeUnitAmplitudePushButton.setToolTip(QCoreApplication.translate("ModelFittingWidget", u"<html><head/><body><p>Adjust \u03b2 such that the model has unit amplitude</p><p>(WARNING: this is not supported by all models)</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.makeUnitAmplitudePushButton.setStatusTip(QCoreApplication.translate("ModelFittingWidget", u"Adjust \u03b2 such that the model has unit amplitude (WARNING: this is not supported by all models)", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.makeUnitAmplitudePushButton.setWhatsThis(QCoreApplication.translate("ModelFittingWidget", u"<html><head/><body><p>Adjust \u03b2 such that the model has unit amplitude</p><p>(WARNING: this is not supported by all models)</p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.generateWaveformPushButton.setStatusTip(QCoreApplication.translate("ModelFittingWidget", u"Generate the model waveform using the initial coefficient values, duration and sampling rate", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.generateWaveformPushButton.setWhatsThis(QCoreApplication.translate("ModelFittingWidget", u"Generate the model waveform using the initial coefficient values, duration and sampling rate", None))
#endif // QT_CONFIG(whatsthis)
        self.generateWaveformPushButton.setText("")
#if QT_CONFIG(tooltip)
        self.exportModelWaveformToolButton.setToolTip(QCoreApplication.translate("ModelFittingWidget", u"Export model waveform (NOT fitted)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.exportModelWaveformToolButton.setStatusTip(QCoreApplication.translate("ModelFittingWidget", u"Export model waveform (NOT fitted)", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.exportModelWaveformToolButton.setWhatsThis(QCoreApplication.translate("ModelFittingWidget", u"Export model waveform (NOT fitted)", None))
#endif // QT_CONFIG(whatsthis)
...
#if QT_CONFIG(tooltip)
        self.fitDataPushButton.setToolTip(QCoreApplication.translate("ModelFittingWidget", u"Fit model to data", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.fitDataPushButton.setStatusTip(QCoreApplication.translate("ModelFittingWidget", u"Fit model to data", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.fitDataPushButton.setWhatsThis(QCoreApplication.translate("ModelFittingWidget", u"Fit model to data", None))
#endif // QT_CONFIG(whatsthis)
        self.fitDataPushButton.setText("")
#if QT_CONFIG(tooltip)
        self.exportFitResultPushButton.setToolTip(QCoreApplication.translate("ModelFittingWidget", u"Export fit results to workspace", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.exportFitResultPushButton.setStatusTip(QCoreApplication.translate("ModelFittingWidget", u"Export fit results to workspace", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.exportFitResultPushButton.setWhatsThis(QCoreApplication.translate("ModelFittingWidget", u"Export fit results to workspace", None))
#endif // QT_CONFIG(whatsthis)
        self.exportFitResultPushButton.setText("")
#if QT_CONFIG(tooltip)
        self.exportFitCurveToolButton.setToolTip(QCoreApplication.translate("ModelFittingWidget", u"Export fitted curve to workspace", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.exportFitCurveToolButton.setStatusTip(QCoreApplication.translate("ModelFittingWidget", u"Export fitted curve to workspace", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.exportFitCurveToolButton.setWhatsThis(QCoreApplication.translate("ModelFittingWidget", u"Export fitted curve to workspace", None))
#endif // QT_CONFIG(whatsthis)
        self.exportFitCurveToolButton.setText(QCoreApplication.translate("ModelFittingWidget", u"Export fitted curve", None))
#if QT_CONFIG(tooltip)
        self.channelSpinBox.setToolTip(QCoreApplication.translate("ModelFittingWidget", u"Select data channel", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.channelSpinBox.setStatusTip(QCoreApplication.translate("ModelFittingWidget", u"Select data channel", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.channelSpinBox.setWhatsThis(QCoreApplication.translate("ModelFittingWidget", u"Select data channel", None))
#endif // QT_CONFIG(whatsthis)
#if QT_CONFIG(tooltip)
        self.pythonHelpPushButton.setToolTip(QCoreApplication.translate("ModelFittingWidget", u"Help on the model function", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.pythonHelpPushButton.setStatusTip(QCoreApplication.translate("ModelFittingWidget", u"Help on the model function", None))
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(whatsthis)
        self.pythonHelpPushButton.setWhatsThis(QCoreApplication.translate("ModelFittingWidget", u"Help on the model function", None))
#endif // QT_CONFIG(whatsthis)
