...
class DataTreeModel(QtCore.QAbstractItemModel):
    ...
    def setData(self, index:QtCore.QModelIndex, value:QtCore.QVariant, 
        ...
        # on the enxt line, consider all roles (i.e. empty list) as the 3ʳᵈ parameter
    ...
    def rowCount(self, parent:QtCore.QModelIndex) -> int:
        # TODO 2025-11-16 21:02:48 FIXME
        # use a version of _dataHasChildren_ returning the number of child elements
        return 0 
    ...
    def hasChildren(self, parent:QtCore.QModelIndex = QtCore.QModelIndex()) -> bool:
        # FIXME 2025-11-16 22:20:20 TODO
...
# ### END   Use the superclass defaults
    ...
    def _dataHasChildren_(self, o:typing.Any) -> bool:
