...
"""
    ...
    def __init__(self, data: object | None = None,
        ...
        *args, **kwargs ⇒ passed on to ScipyenViewer superclass.
        ...
        self._supportedTypes_ = tuple(self.viewer_for_types.keys()) + self.read_only_types
    ...
    def _configureUI_(self):
        ...
        self.toolBar.setObjectName(f"{self.__class__.__name__}_Main_Toolbar")
        ...
        self._toolBarStretcher_ = QtWidgets.QWidget()
    ...
    def slot_showIntrospect(self, value: bool):
        ...
        if self._data_ not in self._supportedTypes_:
            enable = (
                self.showIntrospection
                and onode.introspectable(self._data_)
                )

        else:
            enable = True

        actions = (self.showValuesOnlyAction,self.showCallablesAction,self.showPrivateMembersAction)
        with qtutils.SignalBlocker(actions):
