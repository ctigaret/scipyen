...
class DataViewer(ScipyenViewer):
    ...
    def slot_itemDoubleClicked(self, item, column):
        ...
        objects, names = self.treeWidget.exportDataForItems([item])
        obj = objects[0]
        name = names[0]
    ...
    def slot_customContextMenuRequested(self, point):
        ...
        if len(items) == 1:
            ...
            objects, names =  self.treeWidget.exportDataForItems(items)
    ...
    #     if len(items) == 0:
    #         return
    #     return self.treeWidget.exportDataForItems(items, path_only=True)
    ...
    def slot_copyPaths(self):
        ...
        item_paths = self.treeWidget.getSelectedPaths()
    ...
    def slot_exportToWorkspace(self):
        ...
        objects, names = self.treeWidget.exportDataForItems(items, fullPathAsName=fullPathAsName)
...
#                 src = self.treeWidget._private_data_
#             else:
