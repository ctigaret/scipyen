...
# if __has_PySide6__:
#     from gui.resources.pyside6 import breeze_icons_rc # noqa
#     from gui.resources.pyside6 import breeze_dark_icons_rc # noqa
#     from gui.resources.pyside6 import extra_icons_rc # noqa
#     from gui.resources.pyside6 import images_rc # noqa
# else:
#     from gui.resources.pyqt6 import breeze_icons_rc # noqa
#     from gui.resources.pyqt6 import breeze_dark_icons_rc # noqa
#     from gui.resources.pyqt6 import extra_icons_rc # noqa
#     from gui.resources.pyqt6 import images_rc # noqa
#
# from gui import pictgui as pgui # noqa
# from gui import xmlviewer as xv # noqa
# from gui import textviewer as tv # noqa
# from gui import tableeditor as te # noqa
...
class FileColumnView(QtWidgets.QColumnView):
    ...
    def mouseReleaseEvent(self, evt):
        print(f"{self.__class__.__name__}.mouseReleaseEvent")
        keyboardModifiers = QtWidgets.QApplication.keyboardModifiers()
        if not (keyboardModifiers & QtCore.Qt.ShiftModifier or keyboardModifiers & QtCore.Qt.ControlModifier):
